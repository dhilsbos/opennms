...
public abstract class AbstractFlowIT {
    ...
    public void verifyFlowStack() throws Exception {
        ...
        try (final JestClient client = factory.getObject()) {
            ...
            sendNetflowPacket(minionNetflow5ListenerAddress, "/flows/netflow5.dat");
            sendNetflowPacket(minionNetflow9ListenerAddress, "/flows/netflow9.dat");
            sendNetflowPacket(minionIpfixListenerAddress, "/flows/ipfix.dat");
            sendNetflowPacket(minionSflowListenerAddress, "/flows/sflow.dat");
